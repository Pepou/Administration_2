...
#            self.classeur.ActiveSheet.Name = nom_onglet.replace("/", "_")
            ...
            self.classeur.ActiveSheet.Cells(10,1).Value = "Date de réception"
...
#            self.classeur.ActiveSheet.Cells(10,7).Value = "Date(s) rapport(s)"
            ...
            for instrum in instruments[nom_onglet]:
                ...
                self.classeur.ActiveSheet.Cells((10 + i),3).Value = instrum[3] 
                self.classeur.ActiveSheet.Cells((10 + i),4).Value = instrum[4] 
