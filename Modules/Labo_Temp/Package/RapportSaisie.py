...
class RapportSaisie():
    ...
    def __init__(self, nom_campagne):
        ...
        self.feuille_saisie = os.path.abspath("Modules/Labo_Temp/AppData/Documents/rapportsaisie.xlsm")
        ...
        self.feuille_saisie_travail = os.path.abspath(self.path+"/rapportsaisie.xlsm")
    ...
    def mise_en_forme(self, donnees, nom_fichier):
        ...
        try:
            ...
            classeur = self.xl.Workbooks.Open(self.feuille_saisie_travail)
            ...
            while i > 0:
                ...
                elif donnees[0]["nom_generateur"][i-1] == "HART_1" or donnees[0]["nom_generateur"][i-1] == "HART Scientifique N°1":
                    min = numpy.amin(donnees[0][clef_dico_mesure_etal_non_corri])
                ...
                elif donnees[0]["nom_generateur"][i-1] == "HART_2" or donnees[0]["nom_generateur"][i-1] == "HART Scientifique N°2":
                    min = numpy.amin(donnees[0][clef_dico_mesure_etal_non_corri])
                ...
                elif donnees[0]["nom_generateur"][i-1] == "ESPEC_1" or donnees[0]["nom_generateur"][i-1] == "Etuve ESPEC  N° 1":
                    min = numpy.amin(donnees[0][clef_dico_mesure_etal_non_corri])
                ...
                elif donnees[0]["nom_generateur"][i-1] == "ESPEC_2" or donnees[0]["nom_generateur"][i-1] == "Etuve ESPEC  N° 2":
                    min = numpy.amin(donnees[0][clef_dico_mesure_etal_non_corri])
